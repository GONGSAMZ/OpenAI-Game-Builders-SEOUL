...
- [ ] Authentication → Login Settings에서 사용할 IdP 등록
...
- [ ] Sandbox 로그인 → 콜백 → `/token` 검증 → 게임 세션 발급 확인
...
- https://developers.hiveplatform.ai/en/latest/api/hive-server-api/web-login/integration/getting-started/
